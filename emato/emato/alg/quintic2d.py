...
class Quintic_2d:
    def __init__(self,param, road,traj_traffic_list, xc, desired_v, desired_d):
        """
    ...
    def solve(self):
        ...
        ts = time.time()
        for gd in np.arange(-self.road.road_width/2, self.road.road_width/2, 1) :
        ...
        return self.feasible_candidates, self.invalid_candidates

    def update(self, xc, traffic_traj_sd_list):
        self.xc = xc
