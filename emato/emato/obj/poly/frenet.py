...
from emato.obj.poly.quintic_polynomials_planner import QuinticPolynomial
from emato.obj.poly.cubic_spline_planner import *
...
def generate_target_course(x, y):
    ...
    return np.array(s), np.array(rx), np.array(ry),np.array(ryaw), np.array(rk), csp
